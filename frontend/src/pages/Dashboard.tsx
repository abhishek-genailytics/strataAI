...
export const Dashboard: React.FC = () => {
  ...
  const [costAnalysis, setCostAnalysis] = useState<CostAnalysisType | null>(
    null
  );
  ...
  const fetchDashboardData = useCallback(async () => {
    try {
      ...
      const [summaryResponse, trendsResponse, costResponse] = await Promise.all(
        [
  ...
  return (
    <>
      ...
      {/* Cost Analysis */}
      {costAnalysis && <CostAnalysis data={costAnalysis} loading={loading} />}
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-12">
          <div className="text-center">
            ...
            <p className="text-gray-500 mb-6 max-w-md mx-auto">
              Start making API requests to see your usage analytics and cost
              breakdown.
            </p>
            <a
              href="/playground"
