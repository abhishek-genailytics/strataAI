...
export default function PATsTab(){
  ...
  const columns: Column<any>[] = [
    ...
    { key: 'expires_at', header: 'Expires', sortable: true, accessor: (t)=> t.expires_at ?? '—' },
    { key: 'last_used', header: 'Last used', sortable: true, accessor: (t)=> t.last_used ?? '—' },
    {
      key: 'actions', header: 'Actions', className: 'text-right',
      accessor: (t)=> <Button variant="outline" onClick={()=>setRevokeId(t.id)}>Revoke</Button>
    },
  ]
