...
export default function UsersTab() {
  ...
  const columns: Column<any>[] = [
    ...
    { key: "email", header: "Email", sortable: true, accessor: (m) => m.email },
    {
      ...
      accessor: (m) => (
        <Select
          ...
          onValueChange={(v) => mRole.mutate({ id: m.id, nextRole: v as any })}
        >
          <SelectTrigger>
            <SelectValue />
          </SelectTrigger>
    ...
    },
    {
      ...
      accessor: (m) => (
        <Button variant="outline" onClick={() => setRemoveId(m.id)}>
          Remove
        </Button>
      ),
    },
        ...
        <Dialog open={inviteOpen} onOpenChange={setInviteOpen}>
          ...
          <DialogContent>
            ...
            <DialogFooter>
              ...
              <Button
                onClick={() => mInvite.mutate()}
                disabled={!email || mInvite.isPending}
              >
                Send Invite
              </Button>
            </DialogFooter>
      ...
      >
        <AlertDialogContent>
          ...
          <AlertDialogFooter>
            ...
            <AlertDialogAction
              onClick={() => removeId && mRemove.mutate(removeId)}
