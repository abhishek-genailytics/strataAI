...
export const Toast: React.FC<ToastProps> = ({
  ...
  const getToastStyles = () => {
    const baseStyles = "flex items-start p-4 mb-3 rounded-lg shadow-lg border max-w-sm w-full";
    const typeStyles = {
    ...
    return `${baseStyles} ${typeStyles[type]} ${animationStyles} transition-all duration-300`;
  };

  const getIcon = () => {
    const iconStyles = "w-5 h-5 mr-3 flex-shrink-0 mt-0.5";
